 ...
 * 活动数据
 */
public class CampInfoExtend : IMessageSerialize 
{
	//活动id
	int _id;	
	//类型
	...
	public void Serialize(Stream stream)
	{
		...
		//扩展字段3
		SerializeUtils.WriteString(stream, _ext3);
		//扩展字段4
		SerializeUtils.WriteString(stream, _ext4);
	}
	...
	public void Deserialize(Stream stream)
	{
		...
		//扩展字段3
		_ext3 = SerializeUtils.ReadString(stream);
		//扩展字段4
		_ext4 = SerializeUtils.ReadString(stream);
	}
